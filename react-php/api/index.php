...
{ 
       ...
       $userData =''; 
	   $query = "select * from doctor where username='$username' and password='$password' and status=1"; 
...
function changestat()
{
	...
	$doc_id = $json['doct_id'];
	$feedData = '';
	$sql = "update doctor set status=1 where doc_id=$doc_id";
